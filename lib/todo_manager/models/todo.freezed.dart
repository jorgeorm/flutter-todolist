...
class _$TodoImpl extends _Todo {
  const _$TodoImpl(
      ...
      @JsonKey(name: TodoFields.dueDate) @MillisecondsConverter() this.dueDate,
      @JsonKey(fromJson: _priorityFromDb, toJson: _priorityToDb)
  ...
  @override
  String toString() {
    return 'Todo(id: $id, title: $title, notes: $notes, tags: $tags, dueDate: $dueDate, priority: $priority, isCompleted: $isCompleted, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _Todo extends Todo {
  const factory _Todo(
      ...
      @MillisecondsConverter()
      @JsonKey(name: TodoFields.updatedAt)
      final DateTime? updatedAt}) = _$TodoImpl;
